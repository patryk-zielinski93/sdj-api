  ...
  return function(t) {
    ...
    (function(e) {
      ...
      function r(t, n) {
        ...
        return r.safetySymbolId = r.protocol + '://' + a + ':' + r.port, r.href = r.protocol + '://' + a + (n && n.port === r.port ? '' : ':' + r.port), r;
      }
    ...
    (function(e) {
      ...
      var o = n(10), i = Object.prototype.toString, s = 'function' == typeof e.Blob || '[object BlobConstructor]' === i.call(e.Blob),
    ...
    var o = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function(t) {
        ...
        return t && 'function' == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? 'symbol' : typeof t;
      }, i = n(14), s = n(37), a = n(8), c = n(7), p = n(39), u = n(40), h = n(3)('socket.io-client:manager'), f = n(36), l = n(41),
    ...
    t.exports = r, r.prototype.emitAll = function() {
      ...
      for (var t in this.nsps) d.call(this.nsps, t) && (this.nsps[t].safetySymbolId = this.generateId(t));
      ...
      if (!r) {
        ...
        r.on('connecting', n), r.on('connect', function() {
          r.safetySymbolId = o.generateId(t);
        }), this.autoConnect && n();
      }
      return r;
