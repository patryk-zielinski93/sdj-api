...
@NgModule({
  ...
  exports: [RadioActionMenuComponent, AwesomePlayerTitlePipe, AwesomePlayerSecondTitlePipe],
  declarations: [RadioActionMenuComponent, RadioStationsComponent, AwesomePlayerTitlePipe, AwesomePlayerSecondTitlePipe]
})
